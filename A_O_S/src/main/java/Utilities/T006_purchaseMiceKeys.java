package Utilities;
	...
	public class T006_purchaseMiceKeys {
		...
		public static void miceClick() throws InterruptedException
		{
		    driver.findElement(webEL.miceClick).click();
		    Thread.sleep(4000);
		}
		
		
		public static void clickOnHpMouse() throws InterruptedException
		{
			 driver.findElement(webEL.clickOnHpMouse).click();
			 Thread.sleep(3000);
		}
		...
		public static void clickLogOut() throws InterruptedException
		{
			...
			System.out.println("T006_Mices Page validated Successfully");
			logCollector.debug("T006_Mices Page validated Successfully");
			Thread.sleep(5000);
		}	
